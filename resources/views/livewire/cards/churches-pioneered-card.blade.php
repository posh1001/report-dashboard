<div wire:poll.10s
     class="bg-gradient-to-r from-pink-500 to-rose-500 text-white rounded-2xl shadow-lg p-4 sm:p-6 flex items-center justify-between">
    <div>
        <p class="text-sm font-medium opacity-90">Churches Pioneered</p>
