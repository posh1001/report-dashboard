<div class="max-w-7xl mx-auto px-2 sm:px-4 py-4 ">
    ...
    <div class="mt-6 mb-4 flex justify-end">
        <div class="relative w-full max-w-md">
            <input type="text" wire:model.debounce.500ms="search" placeholder="🔍 Search reports..."
   ...
   <div class="container mt-8 grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
    <!-- Row 1 -->
    ...
    <!-- Row 2 -->
    <livewire:cards.cells-pioneered-card/>
    <livewire:cards.centers-pioneered-card />
    <livewire:cards.churches-pioneered-card />
</div>
    ...
    <!-- Table -->
    <div class="overflow-x-auto overflow-y-auto max-h-[34rem] bg-white rounded-xl shadow-lg p-2 sm:p-4" wire:poll.5s
        ...
        <table class="w-full text-sm text-left border-collapse">
            <thead>
                <tr class="bg-indigo-100 text-gray-700">
                    ...
                    <!-- Step 2 -->
                    <th class="px-2 sm:px-3 py-1 sm:py-2">Number Enrolled In Foundation School</th>
                    <th class="px-2 sm:px-3 py-1 sm:py-2">Number Baptized</th>
                    <th class="px-2 sm:px-3 py-1 sm:py-2">Number Service Centers</th>
                    <th class="px-2 sm:px-3 py-1 sm:py-2">Number Of New Cells </th>
                    <th class="px-2 sm:px-3 py-1 sm:py-2">Returning Invitees From ANOB</th>
                    <th class="px-2 sm:px-3 py-1 sm:py-2">Number Of New Churches </th>
                    <th class="px-2 sm:px-3 py-1 sm:py-2">Highest Service Attendance</th>
