        ...
        @foreach($charts as $title => $chart)
            ...
            <div class="bg-white rounded-2xl shadow-xl p-6 h-80 flex flex-col overflow-x-auto">
                ...
                <div class="flex-1 min-w-full">
                    <svg viewBox="0 0 {{ $chartWidth + $padding*2 }} 160" class="w-full h-full">
                        <!-- Gradient definition -->
                        <defs>
                        ...
                        <!-- Y axis + grid -->
                        <line x1="{{ $padding }}" y1="10" x2="{{ $padding }}" y2="{{ $chartHeight+10 }}" stroke="#6b7280"/>
                        @for($i=0;$i<=5;$i++)
                            @php
                                $yVal = ($i/5) * $max;
                        ...
                        @foreach($groups as $i=>$group)
                            ...
                            @endphp
                            <text x="{{ $xPos }}" y="{{ $chartHeight+25 }}" font-size="10" fill="#6b7280" text-anchor="middle">{{ $group }}</text>
                        @endforeach
                        ...
                        <!-- Data numbers with outline for readability -->
